...
aws dynamodb query $remote --table DemoPlain --index-name GSI-1 \
...
aws dynamodb query $remote --table DemoPlain \
...
aws dynamodb query $remote --table DemoPlain --index-name GSI-3 \
