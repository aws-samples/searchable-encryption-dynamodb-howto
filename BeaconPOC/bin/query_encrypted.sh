...
aws dynamodb query $remote --table DemoEncrypted --index-name GSI-1 \
...
aws dynamodb query $remote --table DemoEncrypted --index-name GSI-0 \
...
aws dynamodb query $remote --table DemoEncrypted --index-name GSI-3 \
